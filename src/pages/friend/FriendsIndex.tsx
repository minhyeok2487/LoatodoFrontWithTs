  ...
  const targetState = modalState
    ...
    const renderRaidStatus = (raidStatus: ReturnType<typeof calculateFriendRaids>) => {
        return raidStatus.map((raid) => {
          ...
          const isAllComplete = raid.dealerChecked + raid.supportChecked === raid.totalCount;
          ...
          return (
            ...
            >
              <RaidHeader>
                <h3 data-count={`${raid.dealerChecked + raid.supportChecked} / ${raid.totalCount}`}>
                    {raid.name}
                </h3>
            </RaidHeader>
              ...
              <RaidContent>
                {raid.difficulties.map((diff) => {
                  ...
                  const isSupportComplete = diff.supportChecked === diff.supportCount;
